...
function populateAircraftInfoWindow(baseProps, plan, sortedRoutePoints, communityAircraftData) {
    ...
    <style>
      ...
      /* --- Shared Tech Style --- */
        ...
        /* --- NEW TAB SWITCHER STYLES (Segmented Control) --- */
        .ac-info-window-tabs {
            padding: 10px 14px;
            border-bottom: 1px solid rgba(255,255,255,0.05);
        ...
        .mode-switch-btn.active {
            ...
            box-shadow: 0 4px 6px -1px rgba(14, 165, 233, 0.3), inset 0 1px 0 rgba(255,255,255,0.2);
    ...
    <div class="info-window-content">
        ...
        <div class="ac-info-window-tabs">
            <div class="mode-switch-track">
                <button class="mode-switch-btn ac-info-tab-btn active" data-tab="ac-tab-flight-data">
                    <i class="fa-solid fa-gauge-high"></i>
                    <span>Flight Inst</span>
                </button>
                <button class="mode-switch-btn ac-info-tab-btn pilot-tab-btn" 
                    data-tab="ac-tab-pilot-report" 
                    data-user-id="${baseProps.userId}" 
                    data-username="${pilotUsername}">
                    <i class="fa-solid fa-user-astronaut"></i>
                    <span>${pilotReportTabText}</span>
                </button>
            </div>
        </div>
    ...
    toggleBtns.forEach(btn => {
        btn.addEventListener('click', (e) => {
            ...
            const target = e.currentTarget.dataset.target; // 'nd-view' || 'fmc-view'
